...
from interface.contract.resources.ui.ui_editor import UiEditor


class Editor(QDialog, UiEditor):
    def __init__(self, agr, user_pk):
        super().__init__()
        self.setupUi(self)

        # 변수 선언
        self.agr, self.user_pk = agr, user_pk
    ...
    def keyPressEvent(self, event):
        if ((not event.modifiers() and
            ...
            event.accept()
        else: super(Editor, self).keyPressEvent(event)
