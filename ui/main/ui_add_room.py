...
"	padding-top: 3px;\n"
"}")
        self.sub_1_frame = QFrame(self.money_frame)
        self.sub_1_frame.setObjectName(u"sub_1_frame")
        self.sub_1_frame.setGeometry(QRect(330, 20, 241, 31))
        self.sub_1_frame.setFrameShape(QFrame.StyledPanel)
        self.sub_1_frame.setFrameShadow(QFrame.Raised)
        self.name_sub_1 = QLabel(self.sub_1_frame)
        self.name_sub_1.setObjectName(u"name_sub_1")
        self.name_sub_1.setGeometry(QRect(0, 0, 61, 30))
        self.label_15 = QLabel(self.sub_1_frame)
        self.label_15.setObjectName(u"label_15")
        self.label_15.setGeometry(QRect(145, 0, 21, 30))
        self.label_15.setStyleSheet(u"QLabel {\n"
"	font-size: 14px;\n"
"	color: rgb(128,128,128);\n"
"	padding-top: 3px;\n"
"}")
        self.edt_sub_1_1 = QLineEdit(self.sub_1_frame)
        self.edt_sub_1_1.setObjectName(u"edt_sub_1_1")
        self.edt_sub_1_1.setGeometry(QRect(90, 0, 76, 30))
        self.edt_sub_1_1.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.label_19 = QLabel(self.sub_1_frame)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setGeometry(QRect(220, 0, 31, 30))
        self.label_19.setStyleSheet(u"QLabel {\n"
"	font-size: 14px;\n"
"	color: rgb(128,128,128);\n"
"	padding-top: 3px;\n"
"}")
        self.edt_sub_1_2 = QLineEdit(self.sub_1_frame)
        self.edt_sub_1_2.setObjectName(u"edt_sub_1_2")
        self.edt_sub_1_2.setGeometry(QRect(171, 0, 70, 30))
        self.edt_sub_1_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.edt_sub_1_1.raise_()
        self.name_sub_1.raise_()
        self.label_15.raise_()
        self.edt_sub_1_2.raise_()
        self.label_19.raise_()
        self.sub_2_frame = QFrame(self.money_frame)
        self.sub_2_frame.setObjectName(u"sub_2_frame")
        self.sub_2_frame.setGeometry(QRect(330, 60, 241, 31))
        self.sub_2_frame.setFrameShape(QFrame.StyledPanel)
        self.sub_2_frame.setFrameShadow(QFrame.Raised)
        self.name_sub_2 = QLabel(self.sub_2_frame)
        self.name_sub_2.setObjectName(u"name_sub_2")
        self.name_sub_2.setGeometry(QRect(0, 0, 61, 30))
        self.edt_sub_2 = QLineEdit(self.sub_2_frame)
        self.edt_sub_2.setObjectName(u"edt_sub_2")
        self.edt_sub_2.setGeometry(QRect(90, 0, 151, 30))
        self.edt_sub_2.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.label_16 = QLabel(self.sub_2_frame)
...
"}")
        ...
        self.label_21 = QLabel(self.premium_frame)
        self.label_21.setObjectName(u"label_21")
        self.label_21.setGeometry(QRect(208, 0, 31, 30))
...
"}")
        ...
        self.edt_total_layer = QLineEdit(self.building_frame)
        self.edt_total_layer.setObjectName(u"edt_total_layer")
        self.edt_total_layer.setGeometry(QRect(420, 20, 151, 30))
        self.edt_total_layer.setEchoMode(QLineEdit.Normal)
        self.edt_total_layer.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
...
"	padding-top: 3px;\n"
"}")
        self.edt_layer = QLineEdit(self.building_frame)
        self.edt_layer.setObjectName(u"edt_layer")
        self.edt_layer.setGeometry(QRect(420, 60, 151, 30))
        self.edt_layer.setEchoMode(QLineEdit.Normal)
        self.edt_layer.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
...
"}")
        ...
        self.btn_parking_true = QPushButton(self.building_frame)
        self.btn_parking_true.setObjectName(u"btn_parking_true")
        self.btn_parking_true.setGeometry(QRect(120, 100, 71, 30))
...
"}")
        ...
        self.btn_parking_false = QPushButton(self.building_frame)
        self.btn_parking_false.setObjectName(u"btn_parking_false")
        self.btn_parking_false.setGeometry(QRect(200, 100, 71, 30))
...
"}")
        ...
        self.btn_parking_true.raise_()
        self.btn_parking_false.raise_()
...
"}")
        ...
        QWidget.setTabOrder(self.edt_admin_cost, self.edt_sub_1_1)
        QWidget.setTabOrder(self.edt_sub_1_1, self.edt_sub_2)
        QWidget.setTabOrder(self.edt_sub_2, self.ckb_cost_in_1)
        ...
        QWidget.setTabOrder(self.edt_parking, self.edt_total_layer)
        QWidget.setTabOrder(self.edt_total_layer, self.edt_layer)
        QWidget.setTabOrder(self.edt_layer, self.edt_household)
    ...
    def retranslateUi(self, AddRoom):
        ...
        self.name_sub_1.setText(QCoreApplication.translate("AddRoom", u"\uae30\ubcf4\uc99d\uae08", None))
        self.label_15.setText(QCoreApplication.translate("AddRoom", u"\ub9cc", None))
        self.edt_sub_1_1.setText("")
        self.label_19.setText(QCoreApplication.translate("AddRoom", u"\ub9cc", None))
        self.edt_sub_1_2.setText("")
        self.name_sub_2.setText(QCoreApplication.translate("AddRoom", u"\uc735\uc790\uae08", None))
        ...
        self.name_premium.setText(QCoreApplication.translate("AddRoom", u"\uad8c\ub9ac\uae08", None))
        self.edt_premium.setText("")
        self.label_21.setText(QCoreApplication.translate("AddRoom", u"\ub9cc\uc6d0", None))
