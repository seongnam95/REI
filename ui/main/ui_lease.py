...
"")
        ...
        QWidget.setTabOrder(self.edt_agreement, self.btn_spell_check)
        QWidget.setTabOrder(self.btn_spell_check, self.btn_preview)
        QWidget.setTabOrder(self.btn_preview, self.btn_add_a)
