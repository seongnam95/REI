...
class Ui_Register(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(401, 431)
        Dialog.setMinimumSize(QSize(401, 431))
        Dialog.setMaximumSize(QSize(401, 431))
...
"        }")
        ...
        self.btn_search.setGeometry(QRect(298, 42, 41, 41))
...
"}")
        ...
        self.type_frame.setGeometry(QRect(20, 190, 361, 131))
...
"}")
        ...
        self.btn_issuance.setGeometry(QRect(90, 350, 241, 45))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"\ub4f1\uae30\ubd80\ub4f1\ubcf8 PDF \ubc1c\uae09", None))
        self.cbx_buildings.setItemText(0, QCoreApplication.translate("Dialog", u"( \uac74\ubb3c\uba85\uce6d / \ub3d9)", None))

        self.lb_sub_title_1.setText(QCoreApplication.translate("Dialog", u"\uc18c\uc7ac\uc9c0 \uac80\uc0c9", None))
        self.cbx_rooms.setItemText(0, QCoreApplication.translate("Dialog", u"( \uc0c1\uc138\uc8fc\uc18c / \ud638 )", None))

        self.btn_search.setText("")
        self.rbtn_set.setText(QCoreApplication.translate("Dialog", u"\uc9d1\ud569\uac74\ubb3c", None))
        self.rbtn_building.setText(QCoreApplication.translate("Dialog", u"\uac74 \ubb3c", None))
        self.rbtn_land.setText(QCoreApplication.translate("Dialog", u"\ud1a0 \uc9c0", None))
        self.cbx_flag.setItemText(0, QCoreApplication.translate("Dialog", u"\ud604\ud589", None))
        self.cbx_flag.setItemText(1, QCoreApplication.translate("Dialog", u"\ud604\ud589+\ud3d0\uc1c4", None))
        self.cbx_flag.setItemText(2, QCoreApplication.translate("Dialog", u"\ud3d0\uc1c4", None))

        self.label.setText(QCoreApplication.translate("Dialog", u"\ub4f1\uae30\uae30\ub85d\uc0c1\ud0dc", None))
        self.btn_issuance.setText(QCoreApplication.translate("Dialog", u"\ub4f1\uae30\ubd80\ub4f1\ubcf8 PDF \uc800\uc7a5", None))
    # retranslateUi
