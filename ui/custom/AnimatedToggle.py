from PySide6.QtGui import QPaintEvent, QBrush, QColor, Qt, QPen
from PySide6.QtWidgets import QCheckBox
from PySide6.QtCore import QPoint, Property, QPointF, QRectF, Slot, QSize, QSequentialAnimationGroup, QEasingCurve, QPropertyAnimation
...
class AnimatedToggle(QCheckBox):
    ...
    def __init__(self, parent=None, bar_color=Qt.gray, checked_color="#00B0FF", handle_color=Qt.white,
        ...
        self.animation.setDuration(150)  # time in ms
